...
window.Win10 = {
    ...
    _init:function () {
        ...
        $(document).on('click', '.win10-btn-change-url', function () {
            ...
            var iframe = Win10.getLayeroByIndex(index).find('iframe');
            layer.prompt({
                title: Win10.lang('Edit URL','Edit URL'),
                formType: 2,
                ...
                layer.close(i);
                layer.msg(Win10.lang('Hold on please...','Hold on please...'),{time:1500},function () {
        ...
        $("#win10-btn-browser").click(function () {
            ...
            // var offset = ['0', '0'];
            layer.prompt({
                title: Win10.lang('Internet Explorer','Visit URL'),
                formType: 2,
                value: '',
                skin:'win10-layer-open-browser',
                area: ['300px', '150px'],
        ...
        Win10.setContextMenu('#win10>.desktop',[
            ['<i class="fa fa-fw fa-star"></i> BookMark ',function () {
    ...
    openUrl: function (url, title,areaAndOffset) {
        if(this._countTask>12){
            layer.msg("Too Much Windows, Man~!!!");
            return false;
        }else{
            this._countTask++;
        }
